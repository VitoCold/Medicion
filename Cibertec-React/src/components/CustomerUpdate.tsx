...
interface ICustomerUpdateProps extends React.Props<any>{ 
    token?: string, localSaveCustomer?: Function 
} 

interface ICustomerUpdateState { 
    firstName: string, lastName: string, city: string, country: string, phone: string 
} 

function mapStateToProps(state: any, ownProps: any) { 
    return { token: state.loginReducer.token, customer: state.customerReducer.customer }; 
} 
...
class CustomerUpdate extends React.Component<any, ICustomerUpdateState> { 
    ...
    render() { 
        let { firstName, lastName, city, country, phone } = this.state; 
                                ...
                                <div className="panel-body"> 
                                    ...
                                    <div>                            
                                        <div className="form-group"> 
                                            <label >Nombres</label> 
                                            <input type="text" className="form-control" placeholder="Nombres" onChange={this.handleNameChange} value={firstName}/> 
                                        </div> 
                                        <div className="form-group"> 
                                            <label >Apellidos</label> 
                                            <input type="text" className="form-control" placeholder="Apellidos" onChange={this.handleLastnameChange} value={lastName}/> 
                                        </div> 
                                        <div className="form-group"> 
                                            <label >Ciudad</label> 
                                            <input type="text" className="form-control" placeholder="Ciudad" onChange={this.handleCiudadChange} value={city}/> 
                                        </div> 
                                        <div className="form-group"> 
                                            <label >Pais</label> 
                                            <input type="text" className="form-control" placeholder="Pais" onChange={this.handlePaisChange} value={country}/> 
                                        </div> 
                                        <div className="form-group"> 
                                            <label >Teléfono</label> 
                                            <input type="tel" className="form-control" placeholder="Teléfono" onChange={this.handleTelefonoChange} value={phone}/> 
                                        </div> 
                                    </div> 
